...
import 'category_bhajan_controller.dart';

class CategoryBhajanView extends StatefulWidget {
  const CategoryBhajanView({super.key});

  @override
  State<CategoryBhajanView> createState() => _CategoryBhajanViewState();
}

class _CategoryBhajanViewState extends State<CategoryBhajanView> {
  CategoryBhajanController controller = Get.put(CategoryBhajanController());
